package foit.product.loranalyst.menu.util;
...
import foit.product.loranalyst.menu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ((AppCompatImageView) viewMenu.findViewById(R.id.menu_item_image)).setImageResource(list.get(i).getImageRes());
